 ...
 * Use the [MotorStatusFragment.newInstance] factory method to
...
class MotorStatusFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_motor_status, container, false)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment MotorStatusFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            MotorStatusFragment().apply {
